...
(function() {
    ...
    const updateMessage = 'Due to Waze legal having issues with us linking to for profit sites that Waze does not have licenses with, the "for reference only" section has been removed until Waze legal can review all links (in both the "legal to use" and "for reference" sections).  Any sites that are not freely open to use or Waze legal cannot get license approval will not be returned to the script.';
    ...
    function LoadMapButtons(){
        ...
        if(settings.HamON){
            ...
            $(insertPath).append($sectionHamON.html());
        ...
        if(settings.NiagON){
            ...
            $(insertPath).append($sectionNiagON.html());
        ...
        if(settings.MissON){
            ...
            $(insertPath).append($sectionMissON.html());
        ...
        //             $(insertPath).append($sectionTorON.html());
