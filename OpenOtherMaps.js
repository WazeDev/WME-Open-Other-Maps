...
(function() {
    ...
    const updateMessage = "Stole the pretty icons from Google MyMaps; these are easier to see on the map.<br><br><h2>.01</h2>Additional error handling and attempting to retrieve the MyMap data if the download fails.";
