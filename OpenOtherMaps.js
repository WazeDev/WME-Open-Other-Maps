...
(function() {
    ...
    const updateMessage = "Adding support for Wegstatus";
    ...
    var WegstatusIcon = "data:image/png;base64,";
    ...
    function initInterface(){
        ...
        $section.html([
            ...
            `<div><input type="checkbox" id="chkWegstatus" class="OOMchk"><label for="chkWegstatus"><img src=${WegstatusIcon} height="18" width="18">Wegstatus</label></div>`,
            '</br><div>',
    ...
    function init(){
        ...
        setChecked('chkWegstatus', settings.Wegstatus);
    ...
    function LoadMapButtons(){
        ...
        $('#OOMWegstatus').remove();
        if(settings.Wegstatus)
        {
            let $section = $("<div>", {style:"padding:8px 16px"});
            $section.html([
                '<span id="OOMWegstatus">',
                `<img src="${WegstatusIcon}" alt="DelDOT" width="18" height="18" id="OOMWegstatusImg" title="Open in Wegstatus" style="cursor:pointer; float: left; display:inline-block; margin: 2px 5px 0 3px;">`,
                '</span>'
            ].join(' '));

            $(insertPath).append($section.html());

            $('#OOMWegstatusImg').click(function(){
                let e=W.map.getCenter();
                let centerPoint = WazeWrap.Geometry.ConvertTo4326(e.lon,e.lat);

                let lon = centerPoint.lon.toString();
                let lat = centerPoint.lat.toString();
                ...
                window.open(`https://www.wegstatus.nl/dashboardnl/lat=${lat}%7Clon=${lon}`, 'Wegstatus');
            });
        }
